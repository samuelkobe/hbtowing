  ...
  <div class="swiper-container swiper-slider flex items-center justify-center">
    ...
    <div class="swiper-wrapper">
      <?php if ( have_rows( 'slider_repeater' ) ) : ?>
      	<?php while ( have_rows( 'slider_repeater' ) ) : the_row(); ?>
      		...
      		<?php if ( $slide_image ) : ?>
            <div class="swiper-slide h-80 md:h-128 lg:h-160 flex items-end justify-center bg-tertiary overflow-hidden">
              ...
              <div class="container absolute mx-auto pb-4">
                <div class="pb-8 md:pb-8 px-4 md:px-8 xl:px-4 max-w-xs lg:max-w-sm">
                  <h4 class="text-secondary text-2xl lg:text-4xl font-bold leading-normal"><?php echo get_sub_field( 'slide_heading' ); ?></h4>
                </div>
    ...
    <div class="container swiper-button-custom-arrow flex justify-between absolute mx-auto h-full lg:px-8 xl:px-4">
      <div class="swiper-button-prev swiper-button-black lg:visible"></div>
      <div class="swiper-button-next swiper-button-black lg:visible"></div>
    </div>
    <!-- Add Pagination -->
