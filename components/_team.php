<div class="container mx-auto relative z-10">
  ...
  <div class="bg-tertiary h-1 w-12 mb-8"></div>
    ...
    <div class="flex flex-row flex-wrap">
        ...
        <div class="flex flex-col w-full sm:w-1/2 xl:w-1/4 p-4 first:pl-0 last:pr-0">
    		<?php if ( get_sub_field( 'team_card_image' ) ) : ?>
    			<img class="min-w-full h-48 object-contain" src="<?php the_sub_field( 'team_card_image' ); ?>" />
    		<?php endif ?>
        <div class="flex flex-row justify-between bg-lightest-gray p-4 xl-p8">
