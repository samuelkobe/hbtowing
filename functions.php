...
if ( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_sub_page('HB Towing Settings');
...
function html5blank_nav()
{
	...
	array(
		...
		'container_id'    => '',
		'menu_class'      => 'menu md:flex text-4xl md:text-base',
		'menu_id'         => '',
		'echo'            => true,
		'fallback_cb'     => false,
		'before'          => '',
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        // wp_register_script('vuejs', 'https://cdn.jsdelivr.net/npm/vue@2.6.12/dist/vue.min.js', '2.6.12'); // Vue.js script
        // wp_enqueue_script('vuejs'); // Enqueue it!
    }
}
...
function html5blank_footer_scripts()
{
  ...
  if (is_page('services')) {
    wp_register_script('services-swiper', get_template_directory_uri() . '/js/swiper/services-swiper.js'); // Conditional script(s)
    wp_enqueue_script('services-swiper'); // Enqueue it!
  }
  if (is_page('why-us')) {
    wp_register_script('services-swiper', get_template_directory_uri() . '/js/swiper/testimonials-swiper.js'); // Conditional script(s)
    wp_enqueue_script('services-swiper'); // Enqueue it!
  }
}
